function ploteta_airy_2meth(j,tj)  
km = 1e3;
h0 = 4e3;
%
...
wave_data = wave_data';
%
fname = ['../../../../../crater_code0716/5eqns_transport/gaussian_RC100_small/muscl/10m/fort.',num2str(n1)];
fname(84) = 'c';
fid       = fopen(fname);
...
%
plot(wave_data(:,1)/km,wave_data(:,3)-h0,'b-',...
     muscl_data(:,1)/km,muscl_data(:,3)-h0,'r-',...
     'LineWidth',1)
hold on
...
%
framest = [num2str(j)];
pname = ['crater_gaussian_RC100_fd_RK_airy_eta' framest];
printpdf(pname)      
