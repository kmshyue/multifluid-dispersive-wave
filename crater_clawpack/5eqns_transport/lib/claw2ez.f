...
c
         write(6,*) 'entered claw2'
c
         call claw2(maxmx,maxmy,meqn,mwaves,maux,mbc,mx,my,
...
c
 1010    format('tend =',d15.4,/,
     ...
     &         d15.4,/,'last cfl =',d15.4,/,'steps taken =',i6,/)
c
  100    continue
c
  999 continue
